...
CREATE USER orb1vct with encrypted password 'orb1vct-secret-pw';
...
GRANT USAGE ON SCHEMA public TO orb1vct;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public to orb1vct;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public to orb1vct;
GRANT ALL PRIVILEGES ON ALL FUNCTIONS IN SCHEMA public to orb1vct;

CREATE USER orb2vct with encrypted password 'orb2vct-secret-pw';
...
GRANT USAGE ON SCHEMA public TO orb2vct;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public to orb2vct;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public to orb2vct;
GRANT ALL PRIVILEGES ON ALL FUNCTIONS IN SCHEMA public to orb2vct;

CREATE USER orb3vct with encrypted password 'orb3vct-secret-pw';
...
GRANT USAGE ON SCHEMA public TO orb3vct;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public to orb3vct;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public to orb3vct;
GRANT ALL PRIVILEGES ON ALL FUNCTIONS IN SCHEMA public to orb3vct;
