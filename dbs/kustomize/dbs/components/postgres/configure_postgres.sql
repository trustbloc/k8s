...
GRANT USAGE ON SCHEMA public TO orbvct;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public to orbvct;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public to orbvct;
GRANT ALL PRIVILEGES ON ALL FUNCTIONS IN SCHEMA public to orbvct;
