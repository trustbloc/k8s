...
declare -A HEALTCHECK_URL=(
    ...
    [registrar]="https://uni-registrar-web.$DOMAIN"
    ...
    [kms]="https://authz-oathkeeper-proxy.$DOMAIN/healthcheck https://ops-oathkeeper-proxy.$DOMAIN/healthcheck https://vault-kms.$DOMAIN/healthcheck https://orb-kms.$DOMAIN/healthcheck"
...
declare -A HEALTHCHECK_CODE=(
    ...
    [https://uni-registrar-web.$DOMAIN]=200
    ...
    [https://orb-kms.$DOMAIN/healthcheck]=200
