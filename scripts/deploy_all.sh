...
declare -A HEALTCHECK_URL=(
    ...
    [kms]="https://authz-oathkeeper-proxy.$DOMAIN/healthcheck https://ops-oathkeeper-proxy.$DOMAIN/healthcheck https://vault-kms.$DOMAIN/healthcheck https://orb-1-kms.$DOMAIN/healthcheck https://orb-2-kms.$DOMAIN/healthcheck https://orb-3-kms.$DOMAIN/healthcheck https://orb-4-kms.$DOMAIN/healthcheck"
...
declare -A HEALTHCHECK_CODE=(
    ...
    [https://orb-3-kms.$DOMAIN/healthcheck]=200
    [https://orb-4-kms.$DOMAIN/healthcheck]=200
